@php
    ...
    $husbandAddress = strtoupper($husbandAddress);
...
<head>
    ...
    <style>
        ...
        .scanned-text {
            ...
            filter: blur(0.2px) contrast(0.85);
            position: relative;
        }
...
<body class="text-black leading-relaxed text-[14px]">
        ...
        <div class="page-content scanned-text">
            ...
            <div class="text-center mb-2">
                <p class="text-left">
                    ...
                    Page No: <strong>{{ $page_no ?? '80' }}</strong> <br>
                    Volume No: <strong>{{ $volume_no ?? '37' }}</strong> <br>
                    Sl. No: <strong>{{ $serial_no ?? '07' }}</strong> <br>
            ...
            <ol class="list-decimal pl-4 space-y-3">
                ...
                <li>
                    ...
                    <strong>
                        {{ $husband_name }}, SON OF- {{ $husband_father_name }} AND 
                        {{ $husband_mother_name }},
                        {{ $husbandAddress }}
                    </strong>
                </li>
                ...
                <li>
                    ...
                    <strong>
                        {{ $name }}, SON OF- {{ $father_name }} AND {{ $mother_name }},
                        {{ $address }}
                    </strong>
                </li>
                <li>
                ...
                <li>
                    Amount of dower: <span class="font-bold">4,00,000/- (FOUR LAKH) TAKA ONLY.</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="font-bold">
                        PAID BY ORNAMENT CASH TAKA. 2,00,000/- (TWO LAKH) TAKA ONLY
                    </div>
                </li>
            </ol>
        </div>
    ...
    <div class="page-2">
        ...
        <!-- Notary Round Seal -->
        <img class="notary-round-seal" src="{{ image_to_base64('notary-round-seal.png') }}">
        <div class="authenticated-seal text-center">
            <!-- Authenticated Seal -->
            <img class="h-25" src="{{ image_to_base64('authenticated-seal.png') }}">
            <div class="date-seal text-purple-700 text-lg font-mono tracking-widest uppercase">
                {{ $doi ?? '25 MAY 2025' }}
            </div>
        </div>

        <div class="page-content scanned-text">
            <div class="text-center mt-[3mm]">(2)</div>
            ...
            <ol class="list-decimal pl-4 space-y-3">
                ...
                <li>
                    Registration fee: <strong>5,000/- (FIVE THOUSANDS) TAKA ONLY</strong>
                </li>
            </ol>
            ...
            <div class="grid grid-cols-3 gap-6 mt-14">
                ...
                <div>
                    <!-- Authenticated Seal -->
                    <img class="h-25" src="{{ image_to_base64('kazi-seal.png') }}">
                    <div class="divide-y-[1px] divide-black">
